...
export default function SignIn() {
  return (
    <>
      <div className="h-screen w-screen justify-center  flex items-center bg-gradient-to-r from-gray-300 to-blue-200">
            ...
            <form>
              <div class="flex flex-row items-center justify-center lg:justify-start mb-4">
                ...
                <button
                  ...
                  class="mx-1 h-9 w-9 rounded-full bg-blue-400 uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]"
                >
                  <svg
